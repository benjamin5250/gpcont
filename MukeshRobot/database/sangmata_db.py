...
#    else:
#        return False
async def get_userdata(chat_id: int,) -> Union[bool, dict]:
...
#    )
async def add_userdata(chat_id: int, user_id: int, username, userfullname, note: dict):
    await _cek_userdata(chat_id)
