...
TRUTH_TEMPLATES = (
    ...
    "{user2} ၏ စကားများသည် ၇၇% မှန်ကန်မှုရှိပါသည်။",
    "{user2} သည်မှန်သောစကားကိုဆိုနေခြင်းမဟုတ်ပါ။",
    "{user2} ပြောဆိုချက်များသည် ၆၃% ဟုတ်မှန်ပါသည်။",
    "{user2} ၏စကားသည် ၂၂% သာမှန်ကန်မှုရှိပါသည်။",
    "{user2} သည် ရာနှုန်းပြည့်လိမ်ညာနေခြင်းဖြစ်ပါသည်။",
    "{user2} ပြောသောစကားများသည် ၅၀% မှန်ကန်မှုရှိပါသည်။",
)
